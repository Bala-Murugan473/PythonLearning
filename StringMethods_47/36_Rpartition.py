print("36. RPARTITION")
# ref 29_Partition.py for comparison
print("*" * 83)
print(
...
4. Search the separator occurrence from right
...
print("Partition with '=' =>", txt.rpartition("="))
print("Partition with 'p' =>", txt.rpartition("p"))
